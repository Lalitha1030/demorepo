...
public class JavaScriptExecutorConcepts {
	...
	public static void main(String[] args) throws IOException {
		...
		//take a screenshot;
		// Take screenshot an store as a file format
		File src = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		// now copy the screenshot to desired location using copyfile // method
		FileUtils.copyFile(src, new File("/Users/kollas/workspace1/SeleniumProj/src/com/sigma/selenium/basic/element.png"));
	...
	public static void flash(WebElement element, WebDriver driver){
		...
		for(int i=0; i<10; i++){
			changColor("rgb(0,200,0)", element, driver);  //1
			changColor(bgColor, element, driver);  //2
